...
@Component({
  ...
  template: `
    <div class="min-h-screen w-full overflow-x-hidden bg-[#06131a] text-slate-100 selection:bg-cyan-400/20 selection:text-cyan-100">
      ...
      <section class="relative w-full overflow-hidden border-b border-white/10">
        ...
        <div class="relative grid min-h-screen w-full gap-16 px-6 pb-20 pt-24 md:px-10 xl:grid-cols-[1.05fr_0.95fr] xl:items-center xl:px-16 2xl:px-24">
          <div class="space-y-8">
            ...
            <div class="space-y-5">
              ...
              <h1 class="max-w-5xl text-5xl font-semibold leading-tight tracking-[-0.04em] text-white md:text-6xl xl:text-7xl [font-family:'Clash_Display','Sora','Plus_Jakarta_Sans',sans-serif]">
              ...
              <p class="max-w-3xl text-base leading-8 text-slate-300 md:text-lg [font-family:'Plus_Jakarta_Sans',sans-serif]">
          ...
          <div class="relative w-full">
            <div class="grid gap-4">
              ...
              <div class="rounded-3xl border border-white/10 bg-slate-950/30 p-6 backdrop-blur-sm">
              ...
              <div class="rounded-3xl border border-amber-400/20 bg-amber-400/10 p-6">
      ...
      <section class="w-full border-b border-white/10 bg-[#071821]">
        <div class="w-full px-6 py-20 md:px-10 xl:px-16 2xl:px-24">
          <div class="mb-12 max-w-4xl">
            ...
            <p class="mt-4 max-w-3xl text-base leading-8 text-slate-400 [font-family:'Plus_Jakarta_Sans',sans-serif]">
      ...
      <section class="relative w-full overflow-hidden">
        ...
        <div class="relative w-full px-6 py-20 md:px-10 xl:px-16 2xl:px-24">
          <div class="w-full border-y border-white/10 bg-white/5 px-8 py-14 text-center backdrop-blur-sm md:px-14">
            ...
            <p class="mx-auto mt-4 max-w-3xl text-base leading-8 text-slate-400 [font-family:'Plus_Jakarta_Sans',sans-serif]">
